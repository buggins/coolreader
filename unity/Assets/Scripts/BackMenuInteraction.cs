...
public class BackMenuInteraction : MenuInteraction {
  ...
  public void quitApp (ControlInput controller, GameObject controllerObject, GameObject button)
  {
    Application.Quit ();
//     UnityEditor.EditorApplication.isPlaying = false;
  }

  public void resume (ControlInput controller, GameObject controllerObject, GameObject button)
  {
