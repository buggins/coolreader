...
public class ReaderAction {
	...
	public final static ReaderAction SHOW_POSITION_INFO_POPUP = new ReaderAction("TOGGLE_TITLEBAR", R.string.action_show_position_info, ReaderCommand.DCMD_SHOW_POSITION_INFO_POPUP, 0 );
