...
public class RK32XXDevice extends BaseDevice {
	...
	private static Method sMethdSetScreenHandWritingRegionLimit = null;
	...
	private static Method sDevMethodCloseFrontLine;
	...
	private static Method sMethodEnableOnyTpd;
	...
	private static Method sInpMethodSetAppCTPDisableRegion;
	private static Method sInpMethodIsAppResetCTPDisableRegion;
	private static Method sInpMethodIsCTPDisableRegion;
	...
	private static Method sHelperMethodSetUserExcludeOptimizationApplication;
	private static Method sHelperMethodSetSingleApplicationConfig;
	...
	public static RK32XXDevice createDevice() {
		if (sInstance == null) {
			...
			sDevMethodCloseFrontLine = ReflectUtil.getMethodSafely(devCtrlCls, "closeFrontLight", Context.class);
			...
			sMethodEnableOnyTpd = ReflectUtil.getMethodSafely(cls, "enableOnyxTpd", Integer.TYPE);
			...
			sMethdSetScreenHandWritingRegionLimit = ReflectUtil.getMethodSafely(cls, "setScreenHandWritingRegionLimit", View.class, int[].class);
			...
			sMethodSetUpdListSize = ReflectUtil.getMethodSafely(cls, "setUpdListSize", Integer.TYPE);
			...
			if (VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
				sInpMethodSetAppCTPDisableRegion = ReflectUtil.getMethodSafely(InputManager.class, "setAppCTPDisableRegion", int[].class, int[].class);
				sInpMethodIsCTPDisableRegion = ReflectUtil.getMethodSafely(InputManager.class, "isCTPDisableRegion");
				sInpMethodIsAppResetCTPDisableRegion = ReflectUtil.getMethodSafely(InputManager.class, "appResetCTPDisableRegion");
			}
			...
			Class einkHelperCls = ReflectUtil.classForName("android.onyx.optimization.EInkHelper");
			sHelperMethodSetUserExcludeOptimizationApplication = ReflectUtil.getMethodSafely(einkHelperCls, "setUserExcludeOptimizationApplication", String.class);
			sHelperMethodSetSingleApplicationConfig = ReflectUtil.getMethodSafely(einkHelperCls, "setSingleApplicationConfig", String.class, String.class);
			sMethodSetTrigger = ReflectUtil.getMethodSafely(cls, "setTrigger", Integer.TYPE);
	...
	public float getMaxTouchPressure() {
		try {
			Float res = (Float) ReflectUtil.invokeMethodSafely(sMethodGetMaxTouchPressure, null);
			return res;
		} catch (Exception e) {
			return 2048.0F;
		}
	...
	public void setScreenHandWritingRegionLimit(View view, int[] array) {
		try {
			ReflectUtil.invokeMethodSafely(sMethdSetScreenHandWritingRegionLimit, view, view, array);
		} catch (Exception e) {
		}
	}
	...
	public void enableTpd(boolean enable) {
		ReflectUtil.invokeMethodSafely(sMethodEnableOnyTpd, null, enable ? 1 : 0);
	}
	...
	public boolean closeFrontLight(Context context) {
		Boolean res = (Boolean) invokeDeviceControllerMethod(context, sDevMethodCloseFrontLine, context);
		if (res == null)
			return false;
		return res;
	}
	...
	public boolean isCTPDisableRegion(Context context) {
		Boolean res = (Boolean) ReflectUtil.invokeMethodSafely(sInpMethodIsCTPDisableRegion, getInputService(context));
		if (res == null)
			return false;
		return res;
	}
	...
	public void appResetCTPDisableRegion(Context context) {
		ReflectUtil.invokeMethodSafely(sInpMethodIsAppResetCTPDisableRegion, getInputService(context));
	}

	public void setAppCTPDisableRegion(Context context, int[] disableRegionArray, int[] excludeRegionArray) {
		ReflectUtil.invokeMethodSafely(sInpMethodSetAppCTPDisableRegion, getInputService(context), disableRegionArray, excludeRegionArray);
	}

	public void setAppCTPDisableRegion(Context context, Rect[] disableRegions, Rect[] excludeRegions) {
		setAppCTPDisableRegion(context, regionsToArray(disableRegions), regionsToArray(excludeRegions));
	}
	...
	public void updateEACAppExcludeList(String jsonString) {
		ReflectUtil.invokeMethodSafely(sHelperMethodSetUserExcludeOptimizationApplication, null, jsonString);
	}

	public void setEACApp(String pkgName, String jsonString) {
		ReflectUtil.invokeMethodSafely(sHelperMethodSetSingleApplicationConfig, null, pkgName, jsonString);
	}
