...
LOCAL_SRC_FILES := \
    ...
    $(FREETYPE_SRC_DIR)/src/base/ftbbox.c \
    $(FREETYPE_SRC_DIR)/src/base/ftbdf.c \
    $(FREETYPE_SRC_DIR)/src/base/ftbitmap.c \
    $(FREETYPE_SRC_DIR)/src/base/ftgasp.c \
    $(FREETYPE_SRC_DIR)/src/cache/ftcache.c \
    $(FREETYPE_SRC_DIR)/src/base/ftglyph.c \
    $(FREETYPE_SRC_DIR)/src/base/ftgxval.c \
    ...
    $(FREETYPE_SRC_DIR)/src/base/ftpatent.c \
    $(FREETYPE_SRC_DIR)/src/base/ftotval.c \
    $(FREETYPE_SRC_DIR)/src/base/ftpfr.c \
    $(FREETYPE_SRC_DIR)/src/base/ftstroke.c \
    $(FREETYPE_SRC_DIR)/src/base/ftsynth.c \
    $(FREETYPE_SRC_DIR)/src/base/ftsystem.c \
    $(FREETYPE_SRC_DIR)/src/base/fttype1.c \
    $(FREETYPE_SRC_DIR)/src/base/ftwinfnt.c \
    $(FREETYPE_SRC_DIR)/src/base/ftxf86.c \
    ...
    $(FREETYPE_SRC_DIR)/src/psnames/psmodule.c \
