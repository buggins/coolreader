...
int OnKeyPressed(int keyId, int state)
{
    ...
    KEY_SHORTCUT_VOLUME_UP, XK_KP_Prior, 0,
    KEY_SHORTCUT_VOLUME_DOWN, XK_KP_Next, 0,
    LONG_SHORTCUT_KEY_VOLUMN_UP, XK_KP_Prior, KEY_FLAG_LONG_PRESS,
    LONG_SHORTCUT_KEY_VOLUMN_DOWN, XK_KP_Next, KEY_FLAG_LONG_PRESS,
    0, 0, 0 // end marker
    };
    int code = 0;
    int flags = 0;
