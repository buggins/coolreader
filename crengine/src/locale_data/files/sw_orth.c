...
const unsigned int sw_lang_orth_chars[] = {
//
...
//
	0xf0f0ffff, 0x0041, 0x005a,	// range	// Swahili doesn't use f, q or x and uses r only for loan words
	0xf0f0ffff, 0x0061, 0x007a,	// range
};
#define SW_LANG_ORTH_SZ	6
