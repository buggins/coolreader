...
<context>
    ...
    <message>
        ...
        <translation type="obsolete">Всички формати (*.fb2 *.txt *.tcr *.rtf *.epub *.html *.htm *.zip);;Книги FB2 (*.fb2 *.fb2.zip);;Текстови файлове (*.txt);;Текст RTF (*.rtf);;HTML (*.htm *.html);;EPUB (*.epub);;Архиви ZIP (*.zip)</translation>
    </message>
    <message>
