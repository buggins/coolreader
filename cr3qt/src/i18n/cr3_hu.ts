...
cvs -z3 -d:pserver:anonymous@crengine.cvs.sourceforge.net:/cvsroot/tinydict co -P tinydict</source>
        <translation type="obsolete">A forráskód letölthető a crengine SourceForge oldaláról.
...
<context>
    ...
    <message>
        ...
        <translation type="obsolete">Minden támogatott formátum (*.fb2 *.txt *.tcr *.rtf *.epub *.html *.htm *.zip);;FB2 könyvek (*.fb2 *.fb2.zip);;Szövegfájlok (*.txt);;Rich text (*.rtf);;HTML fájlok (*.htm *.html);;EPUB fájlok (*.epub);;ZIP archívumok (*.zip)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="obsolete">A keresés jelenleg még nem elérhető funkció</translation>
    </message>
    <message>
